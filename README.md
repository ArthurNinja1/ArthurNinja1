...
Estudante de **Engenharia da Computação (IFMS)** e cursando **Técnico em Desenvolvimento de Sistemas (SENAC)**. 

Desenvolvo soluções no **Full Stack** (Front-end e Back-end), com uma paixão especial e foco em **programação de baixo nível** e arquitetura de sistemas. 
